...
def generate_launch_description():
    ...
    world_arg = DeclareLaunchArgument(
        'world', default_value='small_warehouse.sdf',
    ...
    world_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(pkg_multi_robot_navigation, 'launch', 'world_warehouse_1.launch.py'),
        ),
        launch_arguments={
    ...
    robot_1_spawn_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(pkg_multi_robot_navigation, 'launch', 'spawn_robot_warehouse.launch.py'),
        ),
        launch_arguments={
        'prefix': robot_1,
        'world': 'default',
