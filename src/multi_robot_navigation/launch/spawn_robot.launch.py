...
def generate_launch_description():
    ...
    # ---------------------------------------------------------
    # COMMENTED OUT NODES (not installed on your system)
    # ---------------------------------------------------------
    ...
    #     namespace=LaunchConfiguration('name'),
    #     parameters=[{
    #         'reference_frame_id': PythonExpression(["'", LaunchConfiguration('name'), "/odom'"]),
    ...
    #     namespace=LaunchConfiguration('name'),
    #     parameters=[{
    #         'link_name': PythonExpression(["'", LaunchConfiguration('name'), "/base_link'"])
    #     }],
    #     remappings=[(
    #         '/cmd_vel',
    #         PythonExpression(["'/", LaunchConfiguration('name'), "/cmd_vel'"])
    #     )]
    # )
    ...
    # COMMENTED OUT since nodes are disabled
